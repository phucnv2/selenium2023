...
public class LocatorCRM {
    ...
    // Logout
    public static String buttonAdminIcon = "//li[@class='icon header-user-profile']//a[@data-toggle='dropdown']";
    public static String buttonLogout = "//ul[@class='dropdown-menu animated fadeIn']//li//a[normalize-space()='Logout']";
